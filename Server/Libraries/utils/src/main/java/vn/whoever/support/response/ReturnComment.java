...
@XmlType(propOrder = { "idComment", "ssoIdPoster", "namePoster", "avatarPoster", 
		"content", "timePost", "totalLike", "totalDislike" })
@JsonPropertyOrder(value = { "idComment", "ssoIdPoster", "namePoster", "avatarPoster",
		"content", "timePost", "totalLike", "totalDislike" })
